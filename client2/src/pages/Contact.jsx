...
export default function Contact() {
    ...
    return (
        ...
        <div onClick={closeNav} className="h-[100vw] w-[80vw] mx-auto bg-[#FAFAFF]">
         <div className="pt-[60px] px-[20px]">
        
         
          <div >
              <div className="text-5xl text-[#30343F]" >
               Let's connect.
               </div>
               <div className="text-[#30343f] mt-5 mb-5 text-[22px]">
               ...
               <div className="flex justify-end">
                <button type="submit" className="shadow-xl shadow-black/20 hover:shadow-black/30 hover:-translate-y-0.5 transition-all duration-200 mt-2 px-18 py-2 rounded-md bg-[#FED766] text-[#8892B0] flex items-center gap-2">Send <span className="text-md">{'›'}</span></button>
               </div>
               </form>
           ...
           <div>     
            <div>
               <div className="mt-6 w-full flex justify-center">
                <img className="h-[365px] " src={BALLONSIMAGE}/>
               </div>
            </div>
